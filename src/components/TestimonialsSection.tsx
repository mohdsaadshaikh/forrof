...
const testimonials = [
  {
    quote: "Forrof transformed our brand completely. Their creative vision and attention to detail exceeded all our expectations. The team is incredibly professional and delivered results that truly represent who we are as a company.",
  ...
  {
    quote: "Working with Forrof was a game-changer for our business. They understood our vision perfectly and delivered results that have significantly increased our market presence and customer engagement across all channels.",
    author: "Michael Chen",
    role: "Founder",
    company: "Wellness Co.",
  ...
  {
    quote: "The team at Forrof brings creativity and strategy together beautifully. Our brand has never looked better, and our engagement metrics have increased by over 200% since the rebrand. Highly recommended!",
                ...
                {testimonials.map((_, index) => (
                  <motion.button
                    ...
                    animate={{ 
                      ...
                      backgroundColor: index === current ? "hsl(var(--foreground))" : "hsl(var(--border))"
                    }}
