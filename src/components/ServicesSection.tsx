            ...
            >
              <div className="py-8 md:py-10 flex items-start md:items-center justify-between gap-6">
                ...
                <motion.div
                  ...
                  animate={{
                    backgroundColor: hoveredIndex === index ? "hsl(var(--foreground))" : "transparent",
                    borderColor: hoveredIndex === index ? "hsl(var(--foreground))" : "hsl(var(--border))",
                ...
                >
                  <ArrowUpRight 
                    size={20} 
                    className={hoveredIndex === index ? "text-background" : "text-foreground"}
                  />
                </motion.div>
              </div>
